...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/csveditor.exe: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/csveditor ${OBJECTFILES} ${LDLIBSOPTIONS} -lm -lX11 -lXext -lpthread -lXinerama -lXfixes -lXcursor -lXft -lXrender -lfontconfig -ldl

${OBJECTDIR}/_ext/5c0/CSVFile.o: ../CSVFile.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -g -I.. -I../../deps/fltk-1.3.4-1/inc -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/CSVFile.o ../CSVFile.cpp

${OBJECTDIR}/_ext/5c0/Spreadsheet.o: ../Spreadsheet.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -g -I.. -I../../deps/fltk-1.3.4-1/inc -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/Spreadsheet.o ../Spreadsheet.cpp

${OBJECTDIR}/_ext/5c0/Table.o: ../Table.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -g -I.. -I../../deps/fltk-1.3.4-1/inc -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/Table.o ../Table.cpp

${OBJECTDIR}/_ext/5c0/main.o: ../main.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -g -I.. -I../../deps/fltk-1.3.4-1/inc -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/main.o ../main.cpp
